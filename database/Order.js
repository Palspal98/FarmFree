...
const OrderSQL = sequelize.define(
  'order',
  {
      ...
      bidId: { type: Sequelize.INTEGER, allowNull: true, defaultValue: null },
      hasPaid: { type: Sequelize.TINYINT, allowNull: false, primaryKey: true },
      reviewDetails: { type: Sequelize.INTEGER, allowNull: true, defaultValue: null },
      paymentHash: { type: Sequelize.STRING(64), allowNull: true, defaultValue: null }
  },
  { timestamps: false }
);
